...
<TitledImage src="/public/virtualbox-vscode-extension/vms-list.png" alt="Список виртуальных машин"/>
...
<TitledImage src="/public/virtualbox-vscode-extension/running-vm.gif" alt="Запуск виртуальной машины"/>
<TitledImage src="/public/virtualbox-vscode-extension/stopping-vm.gif" alt="Выключение виртуальной машины"/>
