...
[Why use spyon with mock implemenation rather than jest.fn](https://stackoverflow.com/questions/64930286/why-use-spyon-with-mock-implemenation-rather-than-jest-fn)? - хороший пример, описывающий ситуацию, в которой лучше использовать `jest.spyOn()` вместо `jest.fn()`
...
**Ещё по теме**
- [Understanding Jest Mocks](https://medium.com/@rickhanlonii/understanding-jest-mocks-f0046c68e53c#734c) - подробно описывает каждую рассмотренную функцию с примерами
- [Mock Functions](https://jestjs.io/docs/mock-functions) и [ES6 Class Mocks](https://jestjs.io/docs/es6-class-mocks) - официальная документация jest
