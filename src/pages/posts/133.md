...
archiveExcerpt: |-
  ...
  Я называю обновления атомарными, если компонент обновляется только тогда, когда изменяются данные, которые он использует. У кон...
archiveTags:
  - frontend
  - react
  - statemanagement
...
Я уже упоминал [атомарные обновления ранее](https://t.me/cherkashindev/130), когда говорил о проблемах контекста реакта.
...
3️⃣ [Автосгенерированных селекторы](https://github.com/pmndrs/zustand/blob/main/docs/guides/auto-generating-selectors.md)
...
[Накидал небольшую демку в Codesandbox](https://codesandbox.io/s/zustand-updates-example-2cyk3k)
