...
archiveExcerpt: |-
  ...
  Парни в докладе рассказывают, как можно не заниматься формошлёпством, точнее как его упростить, чт...
archiveTags:
  - fridayreading
  - frontend
  - architecture
...
Сегодня посоветую доклад с HolyJS — [Виталий Полещук, Стёпа Михайлюк — Server-driven UI в вебе. Не пиши, а описывай свой фронтeнд](https://www.youtube.com/watch?v=s4KnMVP9KL4&ab_channel=HolyJS)
...
**Ещё по теме:**
- [Яндекс выпускает DivKit — фреймворк для server-driven UI с открытым кодом](https://habr.com/ru/companies/yandex/articles/683886/)
