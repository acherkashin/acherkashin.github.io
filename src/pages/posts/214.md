...
archiveExcerpt: |-
  ...
  И тогда я впервые задумался, поддерживает ли React дженерики в связке ...
archiveTags:
  - react
  - frontend
  - typescript
...
Ещё один пример можете посмотреть вот [в этом видео](https://www.youtube.com/watch?v=zqz-lEHjJr4&ab_channel=MattPocock)
