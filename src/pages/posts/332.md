...
archiveExcerpt: |-
  ...
  У меня вообще не очень дела с CSS анимациями, но я наконец-то дочитал статью An Introduction To CSS Scroll-Driven Animations и решил рассказать, что такое Scroll Progress Timelines, и показать свою н...
archiveTags:
  - css
  - animations
---
...
У меня вообще не очень дела с CSS анимациями, но я наконец-то дочитал статью [An Introduction To CSS Scroll-Driven Animations](https://www.smashingmagazine.com/2024/12/introduction-css-scroll-driven-animations/) и решил рассказать, что такое **Scroll Progress Timelines**, и [показать свою небольшую демку.](https://www.cherkashin.dev/demos/stories-scroll-demo/?utm_source=telegram&utm_medium=owned&utm_campaign=scroll-animation&utm_term=small-demo-beginning) 

Обязательно откройте статью — там крутые примеры!  Только посмотрите на эту [шикарную демку с сардинами](https://codepen.io/smashingmag/pen/jENrQGo) с ~~шпротами~~ сардинами 🐟.


Если вы писали простейшие анимации, вы знаете, что обычно нужно прописать [длительность цикла анимации:](https://doka.guide/css/animation-duration/)
...
**👉 **[**Моя демка**](https://www.cherkashin.dev/demos/stories-scroll-demo/?utm_source=telegram&utm_medium=owned&utm_campaign=scroll-animation&utm_term=my-demo)
...
🚨 [В общем переходите и поиграйтесь тут](https://www.cherkashin.dev/demos/stories-scroll-demo/?utm_source=telegram&utm_medium=owned&utm_campaign=scroll-animation&utm_term=look-here)


Ещё про анимации на сайте доки:
- [scroll-snap-type](https://doka.guide/css/scroll-snap-type/)
- [keyframes](https://doka.guide/css/keyframes/)
- [animation](https://doka.guide/css/animation/)

[И вот ещё одна демка с тенями прокрутки](https://css-tricks.com/modern-scroll-shadows-using-scroll-driven-animations/)
