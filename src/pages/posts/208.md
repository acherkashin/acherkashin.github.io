...
archiveExcerpt: |-
  ...
  В качестве стейтменеджера использую zustand. Своих девтулзов у него нет, но разработчики реализовали middl...
archiveTags:
  - zustand
  - react
  - statemanagement
archiveImage:
  src: /telegram-media/archive/msg-208-1-archive.webp
  width: 720
  height: 336
---
...
В качестве стейтменеджера использую [zustand](https://github.com/pmndrs/zustand). Своих девтулзов у него нет, но разработчики реализовали middleware для отображения данных в [redux-devtools](https://github.com/reduxjs/redux-devtools).
