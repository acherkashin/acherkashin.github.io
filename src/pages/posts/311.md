...
`caniuse-lite` - легковесная версия, той самой базы [caniuse.com](https://caniuse.com/). Время идёт, появляются новые версии браузеров, а мы используем старую базу, и все наши запросы `">0.2%"` работают с браузерами пяти летней давности.
