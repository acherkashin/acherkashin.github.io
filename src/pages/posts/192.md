...
archiveExcerpt: |-
  ...
  Допустим, мы пишем графический редактор, и нам нужно добавить ...
archiveTags:
  - essential
  - oop
---

[​​](https://telegra.ph/file/f26db6721db56cfc0a50b.jpg)**Полиморфизм**

Полиморфизм в программировании — это способность объектов принимать множество форм. Это означает, что один и тот же код может работать с разными типами данных.

**Пример 1️⃣**

Допустим, мы пишем графический редактор, и нам нужно добавить возможность экспортировать элементы в svg формате \(как в [excalidraw.com](https://excalidraw.com/)\). Напишем метод, который экспортирует массив выделенных элементов в SVG:
...
📌 Я бы сказал, что полиморфизм — это логическое продолжение [абстракции](https://t.me/cherkashindev/167), без которого невозможно было бы реализовать большинство паттернов проектирования. 
